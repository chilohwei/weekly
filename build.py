...
if __name__ == "__main__":
  ...
  readmefile.write("# 奇洛周刊\n\n> 记录 Chiloh 的日常观察，欢迎订阅，也欢迎 [推荐](https://github.com/chilohwei/weekly/discussions/categories/ideas) 你的好东西，Fork 自用可见 [开发文档](https://github.com/chilohwei/weekly/blob/main/Deploy.md)，期待你玩得开心~\n\n")
  ...
  for index, name in enumerate(filenames):
      if name.endswith('.md'):
        ...
        url   = 'https://weekly.chiloh.cn/posts/' + oldTitle
